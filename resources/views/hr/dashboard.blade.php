    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Total Attendance Today</dt>
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['total_attendance_today'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">New Hires This Month</dt>
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['new_hires_this_month'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            @forelse($pendingLeaveRequests as $request)
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">{{ $request->leave_type }} - {{ $request->days_requested }} days</p>
                                        <p class="text-xs text-gray-400">{{ $request->start_date->format('M d') }} - {{ $request->end_date->format('M d, Y') }}</p>
                                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Upcoming Approved Leaves</h3>
                        <div class="space-y-4">
                            @forelse($upcomingLeaves as $leave)
                                <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                                    <div>
                                        <p class="font-medium text-gray-900">{{ $leave->employee->full_name }}</p>
                                        <p class="text-sm text-gray-500">{{ $leave->leave_type }} - {{ $leave->days_requested }} days</p>
